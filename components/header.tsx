      ...
      <nav className="flex space-x-20 mx-auto sm:space-x-16 sm:mx-auto">
        ...
        <div className="">
          <button className="pt-0.5 xl:hover:scale-125" onClick={toggleMode}>
            {boolState ? 
            <svg className="visible text-gray-900 h-6 w-6 fill-none stroke-none stroke-1 dark:text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
